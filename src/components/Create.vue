  ...
  <div class="col-md-12 mt-3">
    <div>
      <div class="position-relative">
        ...
        <label class="create-img" for="select-image">
      ...
      <div v-if="message" class="alert mt-3" :class="successfulCreate ? 'alert-success' : 'alert-danger'">
        {{ message }}
      </div>
...
export default {
  ...
  methods: {
    ...
    editMovie(event) {
      ...
      UserService.createMovie(formData).then((sucRes) => {
        this.loading = false
        if (!sucRes.error) {
          ...
          this.message = sucRes.errors[0]
          this.errors = sucRes.errors
        }
      }, (errRes) => {
        this.loading = false
